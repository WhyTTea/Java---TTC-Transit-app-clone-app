...
public class Card {
	...
	Card(String id, Cardholder owner) {
		this.id = id;
		this.owner = owner;
		this.balance = 19.0;
		this.moneySpent = 0.0;
	...
	void completeMaxSubwayTransaction() {
		double price = 0.0;//Fares.getSharedInstance().getMaxSubwayFare();
		balance -= price;
		moneySpent += price;
		numberOfTransactions += 1;
		this.balance -= price;
	...
	void completeBusTransaction() {
		double price = 0.0;//Fares.getSharedInstance().getBusFare();
		balance -= price;
		moneySpent += price;
		numberOfTransactions += 1;
		this.balance -= price;
	...
	void completeMaxBusTransaction() {
		double price = 0.0;//Fares.getSharedInstance().getMaxBusFare();
		balance -= price;
		moneySpent += price;
		numberOfTransactions += 1;
		this.balance -= price;
